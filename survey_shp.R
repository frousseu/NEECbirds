...
d<-d@data[,c("Nom_EN","Date","Month","Abundance","Long","Lat","Base")]
names(d)<-c("sp","date","month","nb","lon","lat","source")
d<-d[!is.na(d$sp),] # TEMPORAIRE CAR MANQUE NOM FRANCAIS CORRESPONDANCE!!!!
...
s<-read_excel(path="D:/ebird/Sightings_data_20161213.xlsx",sheet=1)
